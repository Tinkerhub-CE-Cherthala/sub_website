...
function Set1() {
  ...
  return (
    ...
    <div className={tab.container}>
      ...
      <a href="https://rzp.io/l/cwc2eCURR" rel="noopener noreferrer" target="_blank" className={tab.regbutton}>register</a>
      <div className={tab.toplights}>
        <div className={tab.toplightdiv}>
          
        </div>
        <div className={tab.toplightdiv}>
          <p className={tab.toplightheading}>Prize pool: 16K</p>
        </div>
      </div>
